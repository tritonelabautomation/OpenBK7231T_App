...
// ── KWS-303WF / BK7231N specific config ─────────────────────────────────────
// Hardware: HT7017 power meter, ST7735 0.96" TFT, latching relay, 3 buttons,
//           NTC thermistor on ADC ch23 (P23). No I2C, no RGB LEDs, no GPS.
// MQTT disabled: re-enable once a valid broker is configured in Config→MQTT.
//   Without a broker the reconnect loop leaks ~1 KB/attempt → OOM → watchdog.
// ─────────────────────────────────────────────────────────────────────────────

#define	ENABLE_DRIVER_SSD1306					0   // no SSD1306 display
#define ENABLE_DRIVER_HT7017					1   // KEEP — your power meter
#define ENABLE_DRIVER_ST7735					1   // KEEP — your TFT display

#define ENABLE_HA_DISCOVERY						1   // KEEP — Home Assistant discovery
#define ENABLE_SEND_POSTANDGET					0   // not needed
#define ENABLE_MQTT								0   // DISABLED — re-enable with valid broker
#define ENABLE_TASMOTADEVICEGROUPS				0   // not needed
#define ENABLE_LITTLEFS							1   // KEEP — filesystem required
#define ENABLE_NTP								1   // KEEP — timer row on display needs it
// #define ENABLE_TIME_DST						1
#define ENABLE_TIME_SUNRISE_SUNSET				0   // not needed
#define ENABLE_DRIVER_LED						0   // no RGB/PWM LEDs on this board
#define ENABLE_DRIVER_BL0937					0   // wrong power meter chip
#define ENABLE_DRIVER_BL0942					0   // wrong power meter chip
#define ENABLE_DRIVER_BL0942SPI					0   // wrong power meter chip
#define ENABLE_DRIVER_CSE7766					0   // wrong power meter chip (have HT7017)
#define ENABLE_DRIVER_TUYAMCU					0   // no TuyaMCU
#define ENABLE_I2C								0   // no I2C devices on this board
#define ENABLE_CALENDAR_EVENTS					0   // not needed
#define ENABLE_DRIVER_BRIDGE					0   // no UART bridge needed
#define ENABLE_DRIVER_HTTPBUTTONS				0   // not needed
#define ENABLE_ADVANCED_CHANNELTYPES_DISCOVERY	1   // KEEP — channel type support
#define ENABLE_DRIVER_WEMO						0   // no Alexa/WeMo emulation
#define ENABLE_DRIVER_HUE						0   // no Philips Hue emulation
#define ENABLE_DRIVER_BATTERY					0   // no battery monitoring
#if PLATFORM_BK7231N || PLATFORM_BEKEN_NEW
// #define ENABLE_DRIVER_PWM_GROUP				1
#define ENABLE_DRIVER_SM16703P					0   // no addressable LEDs
#define ENABLE_DRIVER_PIXELANIM					0   // no LED animations
// dont change this
#define ENABLE_DRIVER_SM15155E					0   // no SM15155E LED driver
#endif
// parse things like $CH1 or $hour etc
#define ENABLE_EXPAND_CONSTANT					1   // KEEP — scripting variables
#define ENABLE_DRIVER_DHT						0   // no DHT — using NTC on ADC
#define ENABLE_DRIVER_AHT2X						0   // no AHT — no I2C
#define ENABLE_DRIVER_TMGN						0
#define ENABLE_DRIVER_DRAWERS					0
#define ENABLE_TASMOTA_JSON						1   // KEEP — lightweight, used by HA
// #define ENABLE_DRIVER_BMPI2C					1
#define ENABLE_DRIVER_DDP						0   // no DDP LED protocol
#define ENABLE_DRIVER_SSDP						0
#define ENABLE_DRIVER_IR						0
#define ENABLE_DRIVER_RC						0
// #define ENABLE_DRIVER_IR2					1
#define ENABLE_DRIVER_DS1820					0   // no DS18B20 — using NTC on ADC
#define ENABLE_DRIVER_CHT83XX					0   // no CHT83XX — no I2C
#define ENABLE_DRIVER_KP18058					0   // no KP18058 LED driver
#define ENABLE_DRIVER_ADCSMOOTHER				1   // KEEP — smooths NTC ADC readings
#define ENABLE_OBK_SCRIPTING					1   // KEEP — relay/button rules
// #define ENABLE_DRIVER_OPENWEATHERMAP			1
#if PLATFORM_BEKEN_NEW
#define NEW_TCP_SERVER							1
#endif
#define ENABLE_DRIVER_NEO6M						0   // no GPS module
...
#if ENABLE_DRIVER_BL0937 || ENABLE_DRIVER_BL0942 || ENABLE_DRIVER_BL0942SPI || ENABLE_DRIVER_CSE7766 || ENABLE_DRIVER_HT7017 || ENABLE_DRIVER_ST7735
